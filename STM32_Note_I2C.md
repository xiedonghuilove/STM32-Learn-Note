...
2. 起始位与停止位的定义：
	...
	-  停止信号：当SCL为高期间，SDA由低到高的跳变；停止信号也是一种电平跳变时序信号，而不是一个电平信号。![I2C起始信号]($res/TIM%E5%9B%BE%E7%89%8720180327181853.png)
3. ACK:
...
![TIM图片20180327182312]($res/TIM%E5%9B%BE%E7%89%8720180327182312.png)
4. 数据的有效性：
I2C总线进行数据传送时，时钟信号为高电平期间，数据线上的数据必须保持稳定，只有在时钟线上的信号为低电平期间，数据线上的高电平或低电平状态才允许
变化。
![TIM图片20180327182531]($res/TIM%E5%9B%BE%E7%89%8720180327182531.png)
5. 数据的传送：
